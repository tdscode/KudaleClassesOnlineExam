            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <%--k<asp:RequiredFieldValidator ID="require_editop2" runat="server" ErrorMessage="Enter option two" ControlToValidate="txt_editoptiontwo" ForeColor="red"></asp:RequiredFieldValidator>--%>
