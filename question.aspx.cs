...
public partial class exam : System.Web.UI.Page
{
    ...
    private void BindData(int id)
    {
        ...
        SqlCommand myCommand = new SqlCommand("spQuestionserachexam",
                                               myConnection);
        myCommand.CommandType = CommandType.StoredProcedure;
        myCommand.Parameters.AddWithValue("@examid", id);
        myCommand.Parameters.AddWithValue("@startRowIndex",
                                          currentPageNumber);
        myCommand.Parameters.AddWithValue("@maximumRows", currentPageNumber);
        ...
        gridview_examquestion.DataSource = ds;
